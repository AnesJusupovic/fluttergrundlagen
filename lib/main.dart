...
import 'package:fluttergrundlagen/presentation/counter_app/widgets/counter_app_page.dart';
    ...
    return Consumer<ThemeService>(builder: (context, themeService, child) {
      return MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          "/root": (BuildContext content) => RootWidget(),
          "/screen1": (BuildContext content) => Screen1(),
          "/screen2": (BuildContext content) => Screen2(),
        },
        home: RootWidget(),
      );
    });
